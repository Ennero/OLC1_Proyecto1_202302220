...
public class Inicio extends Instruccion {
    ...
    public void ejecutarPartida(Entorno entorno, Partida partida) {
        ...
        Salida.salidaInfo.add("    - Cooperaciones: " + df.format(porcentajeCoop1) + "%");
        Salida.salidaInfo.add("    - Defecciones: " + df.format(porcentajeDefc1) + "%");
        ...
        Salida.salidaInfo.add("    - Cooperaciones: " + df.format(porcentajeCoop2) + "%");
        Salida.salidaInfo.add("    - Defecciones: " + df.format(porcentajeDefc2) + "%");
    }
